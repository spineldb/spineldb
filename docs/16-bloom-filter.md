...
<div style="display: flex; justify-content: space-between;">
  <span>⬅️ <strong>Previous Chapter: <a href="./15-troubleshooting.md">15. Operations & Troubleshooting</a></strong></span>
  <span>➡️ <strong>Next Chapter: <a href="./17-hyperloglog.md">17. HyperLogLogs</a></strong></span>
</div>